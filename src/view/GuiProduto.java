	...
	private void definirEventos() {
		...
		table.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				tfNome.setText((String)table.getValueAt(table.getSelectedRow(),0));
				tfPreco.setText((String)table.getValueAt(table.getSelectedRow(),0));
				tfEstoque.setText((String)table.getValueAt(table.getSelectedRow(),0));
			}
		});
		...
		tfLocalizar.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				try {
					String sql = "select * from where nome like '" + tfLocalizar.getText() + "%'";
